...
import FaqItem from "../components/Header/Header";
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet cosectetur, adipisicing elit .Natus
                  quaerat cumque fugit, perspiciatics cum nemo aperiam, aut quia
                  earum amet architecto, modi odio. Soluta unde ducimus
                  perfedrendis
                </p>

                <button className="btn">Request an Apponintment</button>
              </div>
              {/* hero counter */}
            ...
            <div className="xl:w-[670px] ">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  ...
                  ontline scheduling tool to select an Appointment time.
                </li>
              </ul>
              <Link to="/">
